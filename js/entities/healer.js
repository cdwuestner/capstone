    ...
    update: function (dt) {
        ...
        if (this.isSelected) {
            ...
            if(me.input.isKeyPressed("right")){
                me.game.world.addChild(me.pool.pull("HealingRight", this.pos.x - game.HealingRight.width + 43, this.pos.y - game.HealingRight.height + 20));
            }
            if(me.input.isKeyPressed("up")){
                me.game.world.addChild(me.pool.pull("HealingUp", this.pos.x - game.HealingUp.width + 14, this.pos.y - game.HealingUp.height - 10))
            }
